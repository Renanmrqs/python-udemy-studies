...
Muitas condições mesmo if (ruim)
      <- Contagem de complexido (ruim) 
"""

velocidade = 60 # velocidade atual do carro
local_carro = 100 # quilometo da estrada em que o carro está na estrada

RADAR_1 = 60 # velocidade maxima do radar 1
LOCAL_1 = 100 # quilometo da estrada onde o radar 1 está 
